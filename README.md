...
[![GitHub stars](https://img.shields.io/github/stars/voidprajna/GoGoGo?logo=github)](https://github.com/voidprajna/GoGoGo/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/voidprajna/GoGoGo?logo=github)](https://github.com/voidprajna/GoGoGo/network)
[![license](https://img.shields.io/github/license/voidprajna/GoGoGo)](https://github.com/voidprajna/GoGoGo/blob/master/LICENSE)
[![GitHub Release](https://img.shields.io/github/v/release/voidprajna/GoGoGo?label=Release)](https://github.com/voidprajna/GoGoGo/releases)
[![standard-readme compliant](https://img.shields.io/badge/readme%20style-standard-brightgreen.svg?style=flat-square)](https://github.com/RichardLitt/standard-readme)
</div>
<div align="center">

[![Build Check](https://github.com/voidprajna/GoGoGo/actions/workflows/build-check.yml/badge.svg)](https://github.com/voidprajna/GoGoGo/actions/workflows/build-check.yml)
[![CodeQL](https://github.com/voidprajna/GoGoGo/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/voidprajna/GoGoGo/actions/workflows/codeql-analysis.yml)
</div>
...
1. 源码仓库：[Github](https://github.com/voidprajna/GoGoGo)（推荐）、[Gitee](https://gitee.com/itexp/gogogo)（镜像）
2. 下载地址：[Github](https://github.com/voidprajna/GoGoGo/releases)（推荐）、[Gitee](https://gitee.com/itexp/gogogo/releases)（镜像）
...
## 文档
&emsp;&emsp;由于本人并不是做移动开发的，很多功能代码写的都比较差。我也第一次写  Android APP，目前还处在学习中。。。此外，就一个简单的 APP，应该也不需要啥文档，开发过程中遇到的一些问题，我一般都会记录在个人博客中，具体参见：https://blog.csdn.net/voidprajnacsdn/category_10559121.html
...
## 许可证
GPL-3.0-only © voidprajna

[![FOSSA Status](https://app.fossa.com/api/projects/git%2Bgithub.com%2Fvoidprajna%2FGoGoGo.svg?type=large&issueType=license)](https://app.fossa.com/projects/git%2Bgithub.com%2Fvoidprajna%2FGoGoGo?ref=badge_large&issueType=license)
